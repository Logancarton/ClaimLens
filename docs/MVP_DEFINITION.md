...
PMHNP/NP and psychiatrist remain distinct provider identities throughout the benchmark. The same rule path may apply to both when verified rules do not distinguish them.
